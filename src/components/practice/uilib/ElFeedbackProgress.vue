...
<template>
  <div class="practice-section">
    ...
    <el-card>
      <template #header><span class="icon-heading"><WeatherDeskIcon name="automation" /> 실습 3. 시스템 피드백 &amp; 프로그레스 인터랙션</span></template>

      <div class="button-row">
        <el-button type="danger" plain @click="confirmDelete"><WeatherDeskIcon name="delete" /> 서버 파일 삭제 테스트</el-button>
        <el-button type="primary" :loading="isDownloading" @click="startDownload">
          <WeatherDeskIcon name="observation" /> 데이터 동기화 시작
        </el-button>
      </div>
